...
return [
    'modules' => [
        ...
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'BannerApp_Extension' => 0,
        'Boolfly_MomoWallet' => 1,
        'Cloudinary_Cloudinary' => 0,
        ...
        'VaxLtd_PageBuilderCore' => 1,
        'VaxLtd_PageBuilderAppearanceProduct' => 1,
        'VaxLtd_PageBuilderCategoryBlock' => 1,
        'VaxLtd_PageBuilderContentGrid' => 1,
        'VaxLtd_PageBuilder360ViewLargeContextual' => 1,
        'VaxLtd_PageBuilderDualVideo' => 1,
        'VaxLtd_PageBuilderFAQs' => 1,
        'VaxLtd_PageBuilderFlexiPoleBlock' => 1,
        'VaxLtd_PageBuilderHomePageCarousel' => 0,
        'VaxLtd_PageBuilderHotSpotBlock' => 1,
        'VaxLtd_PageBuilderPageBanner' => 1,
        'VaxLtd_PageBuilderSmartWashSlide' => 1,
        'VaxLtd_PageBuilderUserTestimonial' => 1,
        'VaxLtd_PageBuilderVideoBlock' => 1,
        'Vertex_Tax' => 1,
