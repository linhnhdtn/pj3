    ...
    public function checkQuoteItemQty(StockItemInterface $stockItem, $qty, $summaryQty, $origQty = 0)
    {
        ...
        if (!$this->checkQty($stockItem, $summaryQty) || !$this->checkQty($stockItem, $qty)) {
            //$message = __('The requested qty is not available');
			 $message = __('We don\'t have as many "%1" as you requested.', $stockItem->getProductName()). " We have available only ".$stockItem->getQty()." qty in our stock.";
