  ...
  var WidgetDirective = /*#__PURE__*/ (function (_widgetDirectiveAbstr) {
    ...
    _proto.fromDom = function fromDom(data, config) {
      var attributes = _widgetDirectiveAbstr.prototype.fromDom.call(
        ...
        data.testimonial = attributes.testimonial;
    ...
    _proto.toDom = function toDom(data, config) {
      ...
      data.items.sort((propOne, propTwo) => ~~propOne.position - ~~propTwo.position);
        ...
        var attributes = {
            type: "VaxLtd\\PageBuilderUserTestimonial\\Block\\Widget",
            template: "VaxLtd_PageBuilderUserTestimonial::widget.phtml",
            type_name: "PageBuilder User Testimonial",
